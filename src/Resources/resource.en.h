...
// MT-1 — texture palette popup. IDC_BUTTON_PALETTE lives in the
...
// MT-4 — Lighting dialog (View → Lighting…). Sun group + Fill1 + Fill2,
...
// MT-3 — Skydome picker dialog. 4×3 grid (12 slots) for bundled + custom
