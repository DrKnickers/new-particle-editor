...
void EmitterList_DuplicateEmitter(HWND hWnd, float indexDelta = 0.0f);
void EmitterList_MoveEmitter(HWND hWnd, int direction);  // -1 = up, +1 = down; root-only
...
// Size of the multi-selection set (MT-8). Always >= 1 when the
