...
### 3.0 STEP-0 device spike (blocking — no committed render code before this passes)

Two unknowns gate the whole render core and must be settled on the real D3D9Ex device first:
